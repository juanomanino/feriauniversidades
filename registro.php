...
if (!empty($_POST['email']) && !empty($_POST['nombre']) && !empty($_POST['telefono'])) {
	$sql = "INSERT INTO usuarios (email, nombre, telefono) VALUES (:email, :nombre, :telefono)";
...
<body>
	...
	<div class="testbox">
		...
		<form action="registro.php" method="post">
			...
			<label id="icon" for="name"><i class="fa-brands fa-whatsapp"></i></label>
		...
		<a href="index.html"><button class="backb">
			...
			<h6 align="center">Por favor registrarse máximo una vez con los mismos datos.</h6><br>
	</div>
